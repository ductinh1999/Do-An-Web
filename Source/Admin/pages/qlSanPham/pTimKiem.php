...
<?php
	...
	sanpham s, loaisanpham l, xuatxu x, hangsanxuat h WHERE s.MaLoaiSanPham = l.MaLoaiSanPham AND s.MaXuatXu = x.MaXuatXu AND s.MaHangSanXuat = h.MaHangSanXuat and  TenSanPham='".$search."'";
